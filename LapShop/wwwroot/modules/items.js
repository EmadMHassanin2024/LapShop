...
//1- helper   2- file item  3- call api in item list 4- loop 5- draw in sperator function 
var ClsItems = {
    GetAll: function () {
        Helper.AjaxCallGet("https://localhost:7279/Api/Items", {}, "json",
            function (data) {
                ...
                $('#ItemPagination').pagination({
                    ...
                    callback: function (data, pagination) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            ...
                            htmlData += ClsItems.DrwItem(data[i]);
                        }
