...
//to use Identity
//1 add nuget buget Microsoft.AspNetCore.Identity.EntityFrameworkCore
//inheritance from  IdentityDbContext<IdentityUser>
//add service to programe


public partial class LapShop2Context : IdentityDbContext<ApplicationUser>
{
    public LapShop2Context()
    {
    }

    public LapShop2Context(DbContextOptions<LapShop2Context> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
      ...
      base.OnModelCreating(modelBuilder);   
        ...
        modelBuilder.Entity<TbWsetting>(entity =>
        {
            entity.ToTable("TbWSettings");
        });
        ...
        modelBuilder.Entity<VwItemsCategory>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VwItemsCategory");
